 ...
 * @ht: double pointer of type shash_table_t for the hash table
 * @key: const char pointer for unique value to be added
 * @value: const char pointer for associated value with key to be added
 ...
 * Return: the value associated with the element found, NULL if key can't be
 * found
 */
 ...
 * @ht: pointer of type shash_table_t for the hash table
 * Return: Void
 */
